...
let statusImg = document.getElementById("statusImgUrl");
let nikName = document.getElementById("nikName");
let adress = document.getElementById("location");
let mainPostImg = document.getElementById("mainPostImg");
let details = document.getElementById("details");
let saveInfo = document.getElementById("saveInfo");

let sectionRead = document.getElementById("section-read");

let postCard = document.getElementById("filter-post");
let mainModal = document.getElementsByClassName("main-modal")[0];
let closeModal = document.getElementById("close-modal");

let closeModalEdit = document.getElementById("close-modal2");
let statusImgEdit = document.getElementById("statusImgUrlEdit");
let nikNameEdit = document.getElementById("nikNameEdit");
let adressEdit = document.getElementById("locationEdit");
...
<div class="img-post">
  <img
    ...
    style="
      ...
      height: 90%;
      border-radius: 8px;
      -webkit-box-shadow: -1px 1px 15px 4px rgba(34, 60, 80, 0.4);
      -moz-box-shadow: -1px 1px 15px 4px rgba(34, 60, 80, 0.4);
      box-shadow: -1px 1px 15px 4px rgba(34, 60, 80, 0.681);
      margin-top: 20px;
    "
  />
</div>
<div class="card-footer">
  <form class="filter-comment">
    <div class="comm-like">
      <div>
        <img
    ...
    <div class="izb">
      <div>
        <img
          ...
          onclick="izbClick(${information.id})"
          class="izbPostCard"
        />
      </div>
    </div>
